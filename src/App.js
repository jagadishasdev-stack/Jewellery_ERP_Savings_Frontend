...
import EcomPaymentFailed from "./components/e-Commerce/EcomPaymentFailed";
...
const AppLayout = () => {
  ...
  useEffect(() => {
    ...
    CapacitorApp.addListener("backButton", () => {
      ...
      // ✅ If the fullscreen image viewer is open, back just closes it (one
      // step) so the user stays on the product page instead of leaving it.
      ...
      >
        ...
        >
          ...
          <Routes>
            ...
            <Route path="/ecom/paymentfailed" element={<EcomPaymentFailed />} />
