  ...
  useEffect(() => {
    const fetchLedger = async () => {
      ...
      const payload = {
        ...
        // Sent alongside mcode, not instead of it — groupCode/memberCode
        // are unambiguous (mcode can't always be split back apart
        // reliably, since both halves may themselves contain hyphens).
        // The Jewellery ERP compat route prefers these when present.
        groupCode: data.mgroup,
        memberCode: data.member_no,
