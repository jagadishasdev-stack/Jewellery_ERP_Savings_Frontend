...
import EcomTrendingSection from "./e-Commerce/EcomTrendingSection";
import EcomRecentlyViewedSection from "./e-Commerce/EcomRecentlyViewedSection";
...
const userInfo = {
                  ...
                  >
                    ...
                    <Typography
                      sx={{
                        fontSize: "16px",
                        fontWeight: 600,
                        // Metal rates stay gold — the brand's gold accent, not
                        // the crimson used for buttons and active states.
 ...
 {/* Order Details Section */}
              ...
              {/* Shop by Category (e-commerce) — just before Top Deals */}
              {isEcomEnable && <EcomCategoriesSection />}

              {/* Trending (e-commerce) — after Saving Plans. Falls back to
                  Top Deals internally when there's no trending data yet. */}
              {isEcomEnable && <EcomTrendingSection />}
                  ...
                  {promoOfferImages.length > 0 ? (
                    ...
                    <Box
                      sx={{
                        width: "100%",
                        height: "211px",
                        backgroundColor: theme.theme2.offersCardBg,
                        borderRadius: 2,
                        display: "flex",
                      }}
                    >
              ...
              {/* Recently Viewed (e-commerce) — after Promotions & Offers */}
              {isEcomEnable && <EcomRecentlyViewedSection />}
